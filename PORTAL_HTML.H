...
<table><tr><td style='width:120px;'>wifi network<td><input id='s' name='sid' length=32 placeholder='SSID' required></input></td></tr>
<tr><td>wifi passwd<td><input id='p' name='pas' length=64 type='text' placeholder='password' required></input></tr>
<tr><td>admin passwd<td><input  name='aww' length='11' placeholder='max. 10 tekens' value='{aww}' pattern='.{4,10}' title='tussen 4 en 10 karakters'></input></tr> 
